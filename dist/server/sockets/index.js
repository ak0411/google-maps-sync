...
const clientNameGenerator_1 = require("../clientNameGenerator");
let currentController = null;
const nameGenerator = new clientNameGenerator_1.ClientNameGenerator();
...
const socketHandler = (socket, io) => {
    ...
    socket.on("disconnect", () => {
        ...
        if (name) {
            ...
            socket.broadcast.emit("updateClients", Object.fromEntries(connectedClients));
        }
        if (currentController === socket.id) {
            currentController = null;
